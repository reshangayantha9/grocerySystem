...
static Connection c;
    ...
    void search(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("customer_tp"));
                v.add(rs.getString("user_u_id"));
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, 40, 40));

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(204, 204, 204));
        jLabel11.setText("User 01");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 20, -1, -1));

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setText("Sales panel");
        ...
        jPanel2.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Customer TP", "Cashier", "Total Amount"
            }
        ));
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            String sql = "select*from invoice where date like '" + jTextField1.getText() + "%'";
            ResultSet rs = MyConn.search(sql);
            DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
            int a = df.getRowCount();
            for (int i = 0; i < a; i++) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperDesign jd=JRXmlLoader.load("F:\\projects\\java\\grocerySystem\\src\\grocerysystem\\admin\\sales.jrxml");
